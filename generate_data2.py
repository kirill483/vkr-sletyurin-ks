...
class Config:
    data_dir = "data"
    filename = "30GTSP20_val_seed1234.pkl"
    dataset_size = 30
    graph_size = 20
    seed = 1234
    overwrite = True
...
def make_templates_for_rect_fast(x0, y0, w, h, nx, ny, a, length_mode="zero"):
    """
    Возвращает:
        [8, 4] если length_mode == "zero"
        [8, 5] если length_mode == "area"
    """
...
def generate_tsp_data(
    ...
    log_every:
        через сколько созданных примеров печатать прогресс.
        Если None или 0 — не печатать.
    """
