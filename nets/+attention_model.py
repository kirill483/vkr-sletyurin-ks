...
class AttentionModel(nn.Module):
    ...
    def __init__(
        ...
        self.template_dynamic_mlp = MLP(
            input_dim=2 * embedding_dim + 2 + 1 + 2 + 1 + 1,
            hidden_dim=hidden_dim,
            output_dim=embedding_dim,
            n_layers=2,
        )
    ...
    def _get_area_log_p(
        ...
        # Some projects keep StateTSP in a separate module and problem.make_state()
        # may return the older state object. Fall back to visited_fields for compatibility.
    ...
    def _get_template_log_p(
        ...
        coverage_cost = selected_templates[..., 4:5]
